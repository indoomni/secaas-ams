...
import sty from "./PlasmicCitiesPage.module.css"; // plasmic-import: fl7Lz7HPoqIC/css
  ...
  const new$Queries = {
    citiesQuery: usePlasmicDataOp(() => {
      return {
        ...
        opId: "e9cf9e57-87bc-418c-8775-83ede0cd018f",
        userArgs: {
          params: [$state.citiesSearch.value]
        },
        cacheKey: `plasmic.$.e9cf9e57-87bc-418c-8775-83ede0cd018f.$.`,
                ...
                >
                  ...
                  {(() => {
                    const child$Props = {
                      ...
                      autoFocus: true,
                      bordered: true,
                      className: classNames("__wab_instance", sty.citiesSearch),
...
const PlasmicDescendants = {
  ...
  pageLayout: ["pageLayout", "section", "h1", "citiesSearch", "citiesTable"],
  section: ["section", "h1", "citiesSearch", "citiesTable"],
  h1: ["h1"],
