...
import { isLoggedIn as __fn_user__isLoggedIn } from "../../../pages/utils_user"; // plasmic-import: user.isLoggedIn/customFunction
  ...
  return (
    <RichLayout
      ...
      navMenuItems={(() => {
        ...
        __composite["2"]["path"] = `/user/logout`;
        __composite["2"]["name"] = "Logout";
